...
namespace planner
{
                                        ...
                                        Eigen::Vector3d local_target_vel, bool flag_polyInit, bool flag_randomPolyTraj)
  {
    ...
    path_searching(start_pt, local_target_pt, gl_traj);
    ...
    do
    {
      ...
      if (flag_first_call /*|| ( start_pt - local_target_pt ).norm() < 1.0*/) // Initial path generated from a min-snap traj by order.
      {
